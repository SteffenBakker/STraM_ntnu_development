...
from Utils import plot_all_graphs
...
zonal_aggregation_keys = pd.read_csv(r'Data/MoZEES/NTP-aggregering.csv', sep=';')
...
Zones_NGM_ALL = pd.read_csv(r'Data/MoZEES/ZONES_NGM_ALL.csv', sep=';')
...
zones = pd.read_csv(r'Data/MoZEES/zonal_aggregation_steffen.csv', sep=';')
