...
#THE FOLLOWING CAN BE DONE A BIT MORE GENERAL BY LOOPING THROUGH THE ARGUMENTS OF THE instance_dict
...
#first define deterministic model, then easily transformed to a two-stage model. 
