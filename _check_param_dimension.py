...
pd.Series(list(map(count_decimals, list(base_data.C_EDGE_RAIL.values())))).describe()
pd.Series(list(map(count_decimals, list(base_data.C_NODE.values())))).describe()
pd.Series(list(map(count_decimals, list(base_data.C_UPG.values())))).describe()
...
pd.Series(list(map(count_decimals, list(base_data.C_CO2.values())))).describe()
pd.Series(list(map(count_decimals, list(base_data.Q_EDGE_RAIL.values())))).describe()
pd.Series(list(map(count_decimals, list(base_data.Q_NODE_BASE.values())))).describe()
pd.Series(list(map(count_decimals, list(base_data.Q_NODE.values())))).describe()
pd.Series(list(map(count_decimals, list(base_data.Q_EDGE_RAIL.values())))).describe()
pd.Series(list(map(count_decimals, list(base_data.Q_EDGE_BASE_RAIL.values())))).describe()
